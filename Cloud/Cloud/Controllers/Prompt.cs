...
namespace Layout.Controllers
{
    public static class Prompt
    {
        ...
        public static string ShowDialog3(string text, string caption)
        {
            ...
            Label textLabel = new Label() { Left = 50, Top = 20, Text = text, Height = 300, Width = 300 };
            TextBox textBox = new TextBox() { Left = 50, Top = 50, Width = 400, Height = 55 };
            Button confirmation = new Button() { Text = "Ok", Left = 350, Width = 100, Top = 95, Height = 40, DialogResult = DialogResult.OK };
            confirmation.Click += (sender, e) => { prompt.Close(); };
